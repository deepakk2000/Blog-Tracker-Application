...
namespace BTAWebApi.Controllers
{
    ...
    {
        private readonly BTAWebApiContext _context;

        public AdminInfoesController(BTAWebApiContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<AdminInfo>> PostAdminInfo(AdminInfo adminInfo)
        {
          if (_context.AdminInfo == null)
          {
              return Problem("Entity set 'BTAWebApiContext.AdminInfo'  is null.");
          }
